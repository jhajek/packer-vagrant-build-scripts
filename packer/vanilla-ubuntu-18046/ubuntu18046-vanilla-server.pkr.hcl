...
source "virtualbox-iso" "ubuntu-18046-live-server" {
  ...
  iso_urls                = ["http://mirrors.kernel.org/ubuntu-releases/18.04.6/ubuntu-18.04.6-live-server-amd64.iso"]
...
build {
  sources = ["source.virtualbox-iso.ubuntu-18046-live-server"]
  ...
  provisioner "shell" {
    ...
    script          = "../scripts/post_install_ubuntu_18046_vagrant.sh"
  }
