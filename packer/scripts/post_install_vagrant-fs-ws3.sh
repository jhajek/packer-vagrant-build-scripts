...
sudo cp ./hajek/itmt-430/fullstack/nginx-ws/ssl-setup-ws3.conf /tmp
sudo openssl req -new -config /tmp/ssl-setup-ws3.conf -keyout /etc/ssl/private/nginx-selfsigned.key -out /etc/ssl/nginx-certs/selfsigned.crt
