...
export HADOOP_HOME=/home/vagrant/hadoop-2.9.2
export SPARK_HOME=/home/vagrant/spark
export PATH=/sbin:/usr/sbin:/bin:/usr/bin:$HADOOP_HOME/bin:$HADOOP_HOME/sbin:/usr/local/bin:$SPARK_HOME/bin
