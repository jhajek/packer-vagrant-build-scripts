...
sudo cp -v ~/commands/backup/moodle-five-min-cron.sh /etc/cron.d/
sudo cp -v ~/commands/backup/mysqldump-daily.sh /etc/cron.daily/
sudo cp -v ~/commands/backup/moodle-data-dir-backup.sh /etc/cron.daily/
sudo cp -v ~/commands/backup/moodle-www-backup.sh /etc/cron.daily/
